    ...
    */
    ...
    saveEvent() {
        ...
        if (this.event.id) {
            ...
            if (index >= 0) {
                ...
                this.subscribeToSaveResponse(this.perSchedulerService.update(this.perSubmit));
            }
    ...
    deleteEvent() {
        if (this.event.id) {
            ...
            this.dialogVisible = false;
            if (index >= 0) {
                this.perSchedulerService.delete(deletedId).subscribe(response => {
