...
describe('Service Tests', () => {
    describe('FiscalYear Service', () => {
        ...
        beforeEach(() => {
            ...
            elemDefault = new FiscalYear(0, 'AAAAAAA', currentDate, currentDate);
        });
        ...
        describe('Service methods', async () => {
            ...
            it('should create a FiscalYear', async () => {
                const returnedFromService = Object.assign(
                    {
                        id: 0,
                        dateStart: currentDate.format(DATE_FORMAT),
            ...
            it('should update a FiscalYear', async () => {
                const returnedFromService = Object.assign(
                    {
                        code: 'BBBBBB',
                        dateStart: currentDate.format(DATE_FORMAT),
            ...
            it('should return a list of FiscalYear', async () => {
                const returnedFromService = Object.assign(
                    {
                        code: 'BBBBBB',
                        dateStart: currentDate.format(DATE_FORMAT),
            ...
            it('should delete a FiscalYear', async () => {
