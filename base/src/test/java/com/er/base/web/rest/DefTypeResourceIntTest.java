...
public class DefTypeResourceIntTest {
     ...
     *
     * @see com.er.base.repository.search.DefTypeSearchRepositoryMockConfiguration
     */
    @Autowired
    ...
    public void createDefType() throws Exception {
        ...
        verify(mockDefTypeSearchRepository, times(1)).save(testDefType);
    }
    ...
    public void createDefTypeWithExistingId() throws Exception {
        ...
        // Validate the DefType in Elasticsearch
        verify(mockDefTypeSearchRepository, times(0)).save(defType);
    }
    ...
    public void updateDefType() throws Exception {
        ...
        reset(mockDefTypeSearchRepository);

        int databaseSizeBeforeUpdate = defTypeRepository.findAll().size();

        // Update the defType
        DefType updatedDefType = defTypeRepository.findById(defType.getId()).get();
    ...
    public void deleteDefType() throws Exception {
        ...
        // Validate the DefType in Elasticsearch
        verify(mockDefTypeSearchRepository, times(1)).deleteById(defType.getId());
    }
    ...
    public void searchDefType() throws Exception {
        // Initialize the database
        defTypeService.save(defType);
        when(mockDefTypeSearchRepository.search(queryStringQuery("id:" + defType.getId())))
            .thenReturn(Collections.singletonList(defType));
        // Search the defType
