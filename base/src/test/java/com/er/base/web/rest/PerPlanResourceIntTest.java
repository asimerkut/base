...
public class PerPlanResourceIntTest {
    ...
    private static final DayOfWeek DEFAULT_DAY_NO = DayOfWeek.MONDAY;
    private static final DayOfWeek UPDATED_DAY_NO = DayOfWeek.FRIDAY;
     ...
     *
     * @see com.er.base.repository.search.PerPlanSearchRepositoryMockConfiguration
     */
    @Autowired
    ...
    public static PerPlan createEntity(EntityManager em) {
        ...
        // Add required entity
        PerPerson perPerson = PerPersonResourceIntTest.createEntity(em);
        em.persist(perPerson);
        em.flush();
        perPlan.setPerson(perPerson);
        // Add required entity
        DefItem defItem = DefItemResourceIntTest.createEntity(em);
        em.persist(defItem);
        em.flush();
        perPlan.setDers(defItem);
        return perPlan;
    }
    ...
    public void createPerPlan() throws Exception {
        ...
        verify(mockPerPlanSearchRepository, times(1)).save(testPerPlan);
    }
    ...
    public void createPerPlanWithExistingId() throws Exception {
        ...
        // Validate the PerPlan in Elasticsearch
        verify(mockPerPlanSearchRepository, times(0)).save(perPlan);
    }
    ...
    public void updatePerPlan() throws Exception {
        ...
        reset(mockPerPlanSearchRepository);

        int databaseSizeBeforeUpdate = perPlanRepository.findAll().size();

        // Update the perPlan
        PerPlan updatedPerPlan = perPlanRepository.findById(perPlan.getId()).get();
    ...
    public void deletePerPlan() throws Exception {
        ...
        // Validate the PerPlan in Elasticsearch
        verify(mockPerPlanSearchRepository, times(1)).deleteById(perPlan.getId());
    }
    ...
    public void searchPerPlan() throws Exception {
        // Initialize the database
        perPlanService.save(perPlan);
        when(mockPerPlanSearchRepository.search(queryStringQuery("id:" + perPlan.getId())))
            .thenReturn(Collections.singletonList(perPlan));
        // Search the perPlan
