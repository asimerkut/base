...
import {DefRelationTypesourceComponent} from './def-relation-typesource.component';
...
export const defRelationRoute: Routes = [
    {
        ...
        path: 'def-relation-typesource/:id/:code',
        component: DefRelationTypesourceComponent,
        data: {
            authorities: ['ROLE_USER'],
            pageTitle: 'DefRelationTypesource'
        },
        canActivate: [UserRouteAccessService]
    }, {
...
export const defRelationPopupRoute: Routes = [
    ...
    {
        path: 'def-relation-new/:typeId/:typeCode',
        component: DefRelationPopupComponent,
        data: {
            authorities: ['ROLE_USER'],
            pageTitle: 'DefRelations'
