...
export class PerSubmitService {
    ...
    private submitScheduleUrl = SERVER_API_URL + 'api/per-submits-schedule';
    private initScheduleUrl = SERVER_API_URL + 'api/per-submits-initialize';
