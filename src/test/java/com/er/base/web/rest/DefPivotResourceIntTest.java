...
public class DefPivotResourceIntTest {
     ...
     *
     * @see com.er.base.repository.search.DefPivotSearchRepositoryMockConfiguration
     */
    @Autowired
    ...
    public void createDefPivot() throws Exception {
        ...
        verify(mockDefPivotSearchRepository, times(1)).save(testDefPivot);
    }
    ...
    public void createDefPivotWithExistingId() throws Exception {
        ...
        // Validate the DefPivot in Elasticsearch
        verify(mockDefPivotSearchRepository, times(0)).save(defPivot);
    }
    ...
    public void updateDefPivot() throws Exception {
        ...
        reset(mockDefPivotSearchRepository);

        int databaseSizeBeforeUpdate = defPivotRepository.findAll().size();

        // Update the defPivot
        DefPivot updatedDefPivot = defPivotRepository.findById(defPivot.getId()).get();
    ...
    public void deleteDefPivot() throws Exception {
        ...
        // Validate the DefPivot in Elasticsearch
        verify(mockDefPivotSearchRepository, times(1)).deleteById(defPivot.getId());
    }
    ...
    public void searchDefPivot() throws Exception {
        // Initialize the database
        defPivotService.save(defPivot);
        when(mockDefPivotSearchRepository.search(queryStringQuery("id:" + defPivot.getId())))
            .thenReturn(Collections.singletonList(defPivot));
        // Search the defPivot
