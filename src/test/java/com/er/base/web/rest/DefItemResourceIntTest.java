...
public class DefItemResourceIntTest {
     ...
     *
     * @see com.er.base.repository.search.DefItemSearchRepositoryMockConfiguration
     */
    @Autowired
    ...
    public void createDefItem() throws Exception {
        ...
        verify(mockDefItemSearchRepository, times(1)).save(testDefItem);
    }
    ...
    public void createDefItemWithExistingId() throws Exception {
        ...
        // Validate the DefItem in Elasticsearch
        verify(mockDefItemSearchRepository, times(0)).save(defItem);
    }
    ...
    public void updateDefItem() throws Exception {
        ...
        reset(mockDefItemSearchRepository);

        int databaseSizeBeforeUpdate = defItemRepository.findAll().size();

        // Update the defItem
        DefItem updatedDefItem = defItemRepository.findById(defItem.getId()).get();
    ...
    public void deleteDefItem() throws Exception {
        ...
        // Validate the DefItem in Elasticsearch
        verify(mockDefItemSearchRepository, times(1)).deleteById(defItem.getId());
    }
    ...
    public void searchDefItem() throws Exception {
        // Initialize the database
        defItemService.save(defItem);
        when(mockDefItemSearchRepository.search(queryStringQuery("id:" + defItem.getId())))
            .thenReturn(Collections.singletonList(defItem));
        // Search the defItem
