...
public class PerExcuseResourceIntTest {
     ...
     *
     * @see com.er.base.repository.search.PerExcuseSearchRepositoryMockConfiguration
     */
    @Autowired
    ...
    public static PerExcuse createEntity(EntityManager em) {
        ...
        em.flush();
        perExcuse.setPerson(perPerson);
        // Add required entity
        DefItem defItem = DefItemResourceIntTest.createEntity(em);
        em.persist(defItem);
        em.flush();
        perExcuse.setIzin(defItem);
        return perExcuse;
    }
    ...
    public void createPerExcuse() throws Exception {
        ...
        verify(mockPerExcuseSearchRepository, times(1)).save(testPerExcuse);
    }
    ...
    public void createPerExcuseWithExistingId() throws Exception {
        ...
        // Validate the PerExcuse in Elasticsearch
        verify(mockPerExcuseSearchRepository, times(0)).save(perExcuse);
    }
    ...
    public void updatePerExcuse() throws Exception {
        ...
        reset(mockPerExcuseSearchRepository);

        int databaseSizeBeforeUpdate = perExcuseRepository.findAll().size();

        // Update the perExcuse
        PerExcuse updatedPerExcuse = perExcuseRepository.findById(perExcuse.getId()).get();
    ...
    public void deletePerExcuse() throws Exception {
        ...
        // Validate the PerExcuse in Elasticsearch
        verify(mockPerExcuseSearchRepository, times(1)).deleteById(perExcuse.getId());
    }
    ...
    public void searchPerExcuse() throws Exception {
        // Initialize the database
        perExcuseService.save(perExcuse);
        when(mockPerExcuseSearchRepository.search(queryStringQuery("id:" + perExcuse.getId())))
            .thenReturn(Collections.singletonList(perExcuse));
