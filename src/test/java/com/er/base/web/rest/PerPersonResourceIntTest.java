...
public class PerPersonResourceIntTest {
     ...
     *
     * @see com.er.base.repository.search.PerPersonSearchRepositoryMockConfiguration
     */
    @Autowired
    private PerPersonSearchRepository mockPerPersonSearchRepository;
    ...
    public void createPerPerson() throws Exception {
        ...
        verify(mockPerPersonSearchRepository, times(1)).save(testPerPerson);
    }
    ...
    public void createPerPersonWithExistingId() throws Exception {
        ...
        // Validate the PerPerson in Elasticsearch
        verify(mockPerPersonSearchRepository, times(0)).save(perPerson);
    }
    ...
    public void updatePerPerson() throws Exception {
        ...
        reset(mockPerPersonSearchRepository);

        int databaseSizeBeforeUpdate = perPersonRepository.findAll().size();

        // Update the perPerson
        PerPerson updatedPerPerson = perPersonRepository.findById(perPerson.getId()).get();
    ...
    public void deletePerPerson() throws Exception {
        ...
        // Validate the PerPerson in Elasticsearch
        verify(mockPerPersonSearchRepository, times(1)).deleteById(perPerson.getId());
    }
    ...
    public void searchPerPerson() throws Exception {
        // Initialize the database
        perPersonService.save(perPerson);
        when(mockPerPersonSearchRepository.search(queryStringQuery("id:" + perPerson.getId())))
            .thenReturn(Collections.singletonList(perPerson));
