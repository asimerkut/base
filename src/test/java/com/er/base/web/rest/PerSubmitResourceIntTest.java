...
public class PerSubmitResourceIntTest {
     ...
     *
     * @see com.er.base.repository.search.PerSubmitSearchRepositoryMockConfiguration
     */
    @Autowired
    ...
    public static PerSubmit createEntity(EntityManager em) {
        ...
        em.flush();
        perSubmit.setPerson(perPerson);
        // Add required entity
        DefItem defItem = DefItemResourceIntTest.createEntity(em);
        em.persist(defItem);
        em.flush();
        perSubmit.setDers(defItem);
        return perSubmit;
    }
    ...
    public void createPerSubmit() throws Exception {
        ...
        verify(mockPerSubmitSearchRepository, times(1)).save(testPerSubmit);
    }
    ...
    public void createPerSubmitWithExistingId() throws Exception {
        ...
        // Validate the PerSubmit in Elasticsearch
        verify(mockPerSubmitSearchRepository, times(0)).save(perSubmit);
    }
    ...
    public void updatePerSubmit() throws Exception {
        ...
        reset(mockPerSubmitSearchRepository);

        int databaseSizeBeforeUpdate = perSubmitRepository.findAll().size();

        // Update the perSubmit
        PerSubmit updatedPerSubmit = perSubmitRepository.findById(perSubmit.getId()).get();
    ...
    public void deletePerSubmit() throws Exception {
        ...
        // Validate the PerSubmit in Elasticsearch
        verify(mockPerSubmitSearchRepository, times(1)).deleteById(perSubmit.getId());
    }
    ...
    public void searchPerSubmit() throws Exception {
        // Initialize the database
        perSubmitService.save(perSubmit);
        when(mockPerSubmitSearchRepository.search(queryStringQuery("id:" + perSubmit.getId())))
            .thenReturn(Collections.singletonList(perSubmit));
